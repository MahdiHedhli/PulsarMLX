...
mod real {
    ...
    pub fn dsv4_attention(
        ...
        dsv4_attention_at(
            out, 0, q, 0, raw, n_raw, comp, n_comp, allowed, sinks, n_head, head_dim, scale, kvq,
            turbo, pi,
        )
    }
        ...
        check(
            unsafe {
                pulsar_dsv4_attention(
                    ...
                    kvq,
                    turbo,
                    pi.map_or(std::ptr::null(), |b| b.ptr()),
                )
            },
            "dsv4_attention",
        )
