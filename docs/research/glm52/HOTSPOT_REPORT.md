...
- The first qualified optimization is whole-matrix NumPy IQ2_XXS decoding:
  0.050588 s median versus 1.424142 s scalar for one 12,582,912-weight matrix
  (28.15×, exact f32 bits). Integration-level speedup is not yet measured.
- Current order: integrate the qualified decoder at matrix granularity, climb
  the real expert/MoE/layer/P1 ladder, then re-evaluate residency and P2.
