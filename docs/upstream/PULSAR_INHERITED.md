# Inherited Pulsar documentation (Linux + CUDA)

**Historical / inherited Pulsar material.**

These descriptions, model catalogs, CUDA benchmark tables, hardware notes,
acquisition examples, and roadmaps are retained from upstream
[Pulsar](https://github.com/giannisanni/pulsar) (Giannis Anni and contributors)
and from the PulsarMLX fork's early README carry-forward.

They are **not** PulsarMLX Apple Silicon / MLX measurements. They have **not**
been re-run as PulsarMLX evidence. Do not treat tokens/sec figures below as
PulsarMLX performance claims.

Source snapshot: repository history prior to the PulsarMLX Apple-runtime README
redefinition. Upstream project: <https://github.com/giannisanni/pulsar>.
