...
def main():
    ...
    code_manifest = write("f017-apple-production-serial-f32-code-manifest-v3.json", {
        "schema":"pulsarmlx.f017.apple-production-serial-f32-code-manifest","schema_version":"3.0.0","execution_code_head":CODE_HEAD,
    ...
    runtime_rebind = write("f017-apple-production-serial-f32-runtime-rebind-v3.json", {
        "schema":"pulsarmlx.f017.apple-production-serial-f32-runtime-rebind","schema_version":"3.0.0",
    ...
    auth_schema = write("f017-apple-production-serial-f32-future-authorization-schema-v3.json", {
        "schema":"pulsarmlx.f017.apple-production-serial-f32-future-authorization-schema","schema_version":"3.0.0","live_generation_requires_explicit_operator_only_flag":True,"normal_validation_can_generate_live":False,"issued_live_approvals":0,"issued_live_go_tokens":0,
        ...
        "required_disposition":"GO_EXECUTE_ONCE_NO_RETRY","required_approval_statement":"APPLE PRODUCTION SERIAL-F32 EQUIVALENCE SINGLE-USE RELEASE V4 APPROVED","token_reuse":False,"token_generation_tool":{"path":"scripts/research/f017_apple_serial_f32_go_generator_v1.py","sha256":sha(REPO/"scripts/research/f017_apple_serial_f32_go_generator_v1.py")},
    })
    ...
    release = {
        "schema":"pulsarmlx.f017.apple-production-serial-f32-equivalence-release","schema_version":"4.0.0","status":"PREPARED_REVIEW_REQUIRED","event_id":"F017-APPLE-PRODUCTION-SERIAL-F32-EQUIVALENCE-1","release_id":"F017-APPLE-PRODUCTION-SERIAL-F32-EQUIVALENCE-1-RELEASE-4","attempt_id":"F017-APPLE-PRODUCTION-SERIAL-F32-EQUIVALENCE-1-ATTEMPT-1","execution_code_head":CODE_HEAD,
        ...
        "checkpoint_paths":[],"checkpoint_fallback":False,"resume":False,"second_attempt":False,"approval_schema_fields":json.loads(auth_schema.read_text())["approval_fields"],"go_token_schema_fields":json.loads(auth_schema.read_text())["go_token_fields"],"required_approval_statement":"APPLE PRODUCTION SERIAL-F32 EQUIVALENCE SINGLE-USE RELEASE V4 APPROVED","real_event_authorized":False,"live_go_token_created":False,"stop_boundary":"AFTER_SINGLE_APPLE_PRODUCTION_SERIAL_F32_CAPTURE_AND_FROZEN_COMPARISON_ONLY","determinism_authority":"SEPARATE_FUTURE_RELEASE_REQUIRED",
    }
    release_path=write("f017-apple-production-serial-f32-equivalence-single-use-release-v4.json",release)
    ...
    write("f017-apple-production-serial-f32-inert-go-fixture-v2.json",inert)
