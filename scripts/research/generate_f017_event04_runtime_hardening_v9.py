...
def render() -> dict[Path, bytes]:
    ...
    implementation = {name: binding(path) for name, path in {
        ...
        "canonical_serialization": "scripts/research/f017_canonical_serialization_v8.py",
        "lifecycle_artifact_banker": "scripts/research/f017_lifecycle_artifact_v8.py",
        "comparison": "scripts/research/f017_corrected_oracle_compare_v8.py",
        "macos_memory_observation": "scripts/research/f017_macos_memory_observation_v1.py",
        "primary_numerical_core": "scripts/research/f017_corrected_oracle_primary_numerics_v2.py",
        "secondary_numerical_core": "scripts/research/f017_corrected_oracle_secondary_numerics_v2.py",
        "primary_decoder": "scripts/research/f017_oracle_primary_decoders.py",
        "ggml_kquants": "scripts/research/ggml_kquants.py",
        "dense_primitives": "scripts/research/glm52_dense_primitives.py",
        "gguf_catalog": "scripts/research/glm52_gguf_catalog.py",
        "tensor_store": "scripts/research/glm52_tensor_store.py",
        "iq2_s_dequant": "scripts/research/iq2_s_dequant.py",
        "iq2_xxs_dequant": "scripts/research/iq2_xxs_dequant.py",
        "iq2_xxs_tables": "scripts/research/iq2_xxs_tables.py",
        "iq3_xxs_dequant": "scripts/research/iq3_xxs_dequant.py",
        "iq3_xxs_tables": "scripts/research/iq3_xxs_tables.py",
        "iq4_xs_dequant": "scripts/research/iq4_xs_dequant.py",
        "iq_extra_tables": "scripts/research/iq_extra_tables.py",
        "quantization_matrix_support": "scripts/research/qualify_f017_quantization_matrix_v1.py",
        "synthetic_checkpoint_builder": "scripts/research/f017_synthetic_checkpoint_v9.py",
    }.items()}
    runtime = {"schema": "pulsarmlx.f017.event04-runtime-hardening/9.0.0", "status": "IMPLEMENTED_PENDING_WHOLE_DOMAIN_ACCEPTANCE",
               ...
               "runtime_import_closure": sorted([
                   binding["path"] for binding in implementation.values()
                   if binding["path"] in {
                       "scripts/research/execute_f017_corrected_oracle_event_v9.py",
                       "scripts/research/f017_canonical_serialization_v8.py",
                       "scripts/research/f017_checkpoint_identity_producer_v9.py",
                       "scripts/research/f017_corrected_oracle_authorization_v9.py",
                       "scripts/research/f017_corrected_oracle_compare_v8.py",
                       "scripts/research/f017_corrected_oracle_event_accounting_v9.py",
                       "scripts/research/f017_corrected_oracle_primary_numerics_v2.py",
                       "scripts/research/f017_corrected_oracle_primary_target_source_v9.py",
                       "scripts/research/f017_corrected_oracle_primary_v9.py",
                       "scripts/research/f017_corrected_oracle_secondary_numerics_v2.py",
                       "scripts/research/f017_corrected_oracle_secondary_target_source_v9.py",
                       "scripts/research/f017_corrected_oracle_secondary_v9.py",
                       "scripts/research/f017_descriptor_lease_manager_v9.py",
                       "scripts/research/f017_lifecycle_artifact_v8.py",
                       ...
                       "scripts/research/ggml_kquants.py",
                       "scripts/research/glm52_dense_primitives.py",
                       "scripts/research/glm52_gguf_catalog.py",
                       "scripts/research/glm52_tensor_store.py",
                       "scripts/research/iq2_s_dequant.py",
                       "scripts/research/iq2_xxs_dequant.py",
                       "scripts/research/iq2_xxs_tables.py",
                       "scripts/research/iq3_xxs_dequant.py",
                       "scripts/research/iq3_xxs_tables.py",
                       "scripts/research/iq4_xs_dequant.py",
                       "scripts/research/iq_extra_tables.py",
