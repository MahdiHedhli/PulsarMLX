#!/usr/bin/env python3
"""V10 six-shard identity stage with five retained graph descriptor leases."""
from __future__ import annotations

from f017_descriptor_lease_manager_v10 import LeaseSet, acquire_production_leases, acquire_synthetic_leases
