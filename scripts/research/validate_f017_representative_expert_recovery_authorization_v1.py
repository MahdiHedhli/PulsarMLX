...
def validate(root: Path, auth: dict[str, Any] | None = None) -> str:
    ...
    require(output.get("individual_outputs")==8 and output.get("canonical_order")==SELECTED and output.get("two_fresh_process_reproductions_required")==2 and output.get("all_eight_output_sha256_exact") is True,"OUTPUT")
