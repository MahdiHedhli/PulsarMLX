#!/usr/bin/env python3
"""Generate the bounded Q2_K qualification table."""
...
SOURCE = ROOT / "docs/research/glm52/raw/post-f016-q2-k-numpy-qualification-0001.json"
TABLE = ROOT / "docs/research/glm52/tables/post-f016-q2-k-numpy-qualification-0001.md"
...
def render(record: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            f"Layer-78 expert-242 gate median decode-only ratio: **{record['benchmark']['median_decode_speedup']:.2f}x**.",
            "",
...
def main() -> int:
    ...
    if args.check:
        if not TABLE.exists() or TABLE.read_text() != rendered:
            raise SystemExit("generated Q2_K table is stale")
    else:
