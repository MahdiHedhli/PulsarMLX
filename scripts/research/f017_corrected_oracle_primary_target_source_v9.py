...
class PrimaryDescriptorSourceV9:
    ...
    def matrix(self, name: str, rows: int, columns: int):
        return PrimaryRowMatrixV9(self, name, None, rows, columns)
    ...
    def expert(self, name: str, expert: int, rows: int, columns: int):
        ...
        return PrimaryRowMatrixV9(self, name, expert, rows, columns)
...
class PrimaryRowMatrixV9:
    def __init__(self, source: PrimaryDescriptorSourceV9, name: str, expert: int | None, rows: int, columns: int):
...
def source_from_inherited_descriptors(candidate: dict, descriptors: list[dict], file_descriptors: list[int]):
    source = PrimaryDescriptorSourceV9(candidate, descriptors, file_descriptors); source.exercise_format_probes()
