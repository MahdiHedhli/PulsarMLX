...
FULL_NATIVE = EVIDENCE / "f017-event05-readiness-interface-full-native-ci-v4.json"
...
def main() -> int:
    ...
    gemini = EVIDENCE / "f017-event05-readiness-interface-prepared-gemini-fixture-v1.json"
    opus = EVIDENCE / "f017-event05-readiness-interface-prepared-opus-fixture-v2.json"
    ...
    manifest = EVIDENCE / "f017-event05-readiness-interface-prepared-runtime-authority-manifest-v3.json"
    _write(manifest, {"schema":contract["scope_policy"]["VALIDATION_ONLY_PREPARED"]["manifest_schema"],
        "supersedes":"docs/architecture/reviews/evidence/f017-event05-readiness-interface-prepared-runtime-authority-manifest-v2.json",
        "authority_scope":"VALIDATION_ONLY_PREPARED", "final_authority":False,
    ...
    declaration = EVIDENCE / "f017-event05-readiness-interface-prepared-declaration-v3.json"
    _write(declaration, value)
    approval = EVIDENCE / "f017-event05-readiness-interface-prepared-validation-only-approval-v3.json"
    _write(approval, {"schema":"pulsarmlx.f017.event05-readiness-validation-only-approval/1.0.0",
        ...
        "authorization_id":"F017-V11-EVENT05-PREPARED-VALIDATION-AUTH-3",
        "package_attempt_id":"F017-V11-EVENT05-PREPARED-VALIDATION-PACKAGE-3",
        "primary_event_id":"F017-V11-EVENT05-PREPARED-VALIDATION-PRIMARY-3",
        "secondary_event_id":"F017-V11-EVENT05-PREPARED-VALIDATION-SECONDARY-3",
        "checkpoint_root":"/nonexistent/f017-event05-prepared-validation-checkpoint-v3",
        "canonical_authorization_path":"/nonexistent/f017-event05-prepared-validation-authorization-v3.json",
        "installation_receipt_path":"/nonexistent/f017-event05-prepared-validation-receipt-v3.json",
        "emergency_evidence_root":"/nonexistent/f017-event05-prepared-validation-emergency-v3",
        "terminal_fallback_evidence_root":"/nonexistent/f017-event05-prepared-validation-fallback-v3",
    ...
    with tempfile.TemporaryDirectory(prefix="f017-event05-prepared-v3-") as raw:
    ...
    report_path = EVIDENCE / "f017-event05-readiness-interface-prepared-production-instantiability-v3.json"
    _write(report_path, {"schema":"pulsarmlx.f017.event05-readiness-interface-prepared-production-instantiability/1.2.0",
        "authority_scope":"VALIDATION_ONLY_PREPARED", "final_authority":False,
