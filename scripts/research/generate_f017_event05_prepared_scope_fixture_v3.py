...
FULL_NATIVE = EVIDENCE / "f017-event05-readiness-interface-full-native-ci-v5.json"
...
def main() -> int:
    ...
    gemini = EVIDENCE / "f017-event05-readiness-interface-prepared-gemini-fixture-v2.json"
    opus = EVIDENCE / "f017-event05-readiness-interface-prepared-opus-fixture-v3.json"
    ...
    manifest = EVIDENCE / "f017-event05-readiness-interface-prepared-runtime-authority-manifest-v4.json"
    _write(manifest, {"schema":contract["scope_policy"]["VALIDATION_ONLY_PREPARED"]["manifest_schema"],
        "supersedes":"docs/architecture/reviews/evidence/f017-event05-readiness-interface-prepared-runtime-authority-manifest-v3.json",
        "authority_scope":"VALIDATION_ONLY_PREPARED", "final_authority":False,
    ...
    declaration = EVIDENCE / "f017-event05-readiness-interface-prepared-declaration-v4.json"
    _write(declaration, value)
    approval = EVIDENCE / "f017-event05-readiness-interface-prepared-validation-only-approval-v4.json"
    _write(approval, {"schema":"pulsarmlx.f017.event05-readiness-validation-only-approval/1.0.0",
        ...
        "authorization_id":"F017-V11-EVENT05-PREPARED-VALIDATION-AUTH-4",
        "package_attempt_id":"F017-V11-EVENT05-PREPARED-VALIDATION-PACKAGE-4",
        "primary_event_id":"F017-V11-EVENT05-PREPARED-VALIDATION-PRIMARY-4",
        "secondary_event_id":"F017-V11-EVENT05-PREPARED-VALIDATION-SECONDARY-4",
        "checkpoint_root":"/nonexistent/f017-event05-prepared-validation-checkpoint-v4",
        "canonical_authorization_path":"/nonexistent/f017-event05-prepared-validation-authorization-v4.json",
        "installation_receipt_path":"/nonexistent/f017-event05-prepared-validation-receipt-v4.json",
        "emergency_evidence_root":"/nonexistent/f017-event05-prepared-validation-emergency-v4",
        "terminal_fallback_evidence_root":"/nonexistent/f017-event05-prepared-validation-fallback-v4",
    ...
    with tempfile.TemporaryDirectory(prefix="f017-event05-prepared-v4-") as raw:
    ...
    report_path = EVIDENCE / "f017-event05-readiness-interface-prepared-production-instantiability-v4.json"
    _write(report_path, {"schema":"pulsarmlx.f017.event05-readiness-interface-prepared-production-instantiability/1.3.0",
        "authority_scope":"VALIDATION_ONLY_PREPARED", "final_authority":False,
