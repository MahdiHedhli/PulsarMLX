#!/usr/bin/env python3
"""V9 secondary wrapper over the unchanged binary32 pure core."""
...
from f017_corrected_oracle_secondary_target_source_v9 import source_from_inherited_descriptors
...
def execute(candidate: dict, descriptors: list[dict], file_descriptors: list[int]) -> dict:
    ...
    store, document, formats, shards = source_from_inherited_descriptors(candidate, descriptors, file_descriptors)
