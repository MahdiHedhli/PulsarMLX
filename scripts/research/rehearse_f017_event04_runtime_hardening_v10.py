#!/usr/bin/env python3
"""Production-shaped V10 execution rehearsal with zero checkpoint payload access."""
...
from validate_f017_corrected_oracle_access_v10 import install_rehearsal_candidate, render_rehearsal_candidate, validate_installed_rehearsal
...
def rehearse(output: Path) -> dict:
    ...
    with tempfile.TemporaryDirectory(prefix="f017-event04-v10-shadow-") as raw:
        ...
        core = {"schema": "pulsarmlx.f017.event04-production-shadow-deterministic-core/10.0.0", "result": "PASS",
        ...
        envelope = {"schema": "pulsarmlx.f017.event04-production-shadow-volatile-envelope/10.0.0",
    ...
    result = {"schema": "pulsarmlx.f017.event04-production-shaped-rehearsal/10.0.0", "result": "PASS",
