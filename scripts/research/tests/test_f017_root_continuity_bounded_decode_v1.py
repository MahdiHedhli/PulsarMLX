...
@pytest.mark.parametrize(
    ...
    [
        ...
        "from json import decoder as backend\nbackend.JSONDecoder().decode('{}')\n",
        "import json.scanner\njson.scanner.make_scanner(None)\n",
        "import json.encoder\njson.encoder.JSONEncoder().encode({})\n",
        "import json.tool\njson.tool.main()\n",
        "import json.decoder\njson.decoder.scanstring('', 0)\n",
        "import json.decoder\njson.decoder.c_scanstring('', 0)\n",
        "import json.decoder\njson.decoder.JSONDecoder(object_pairs_hook=dict).decode('{}')\n",
        "import json.decoder\njson.decoder.JSONDecoder(parse_constant=float).decode('NaN')\n",
        "_LoaderType = type(__spec__.loader)\n_LoaderType('json', '/tmp/json.py').load_module()\n",
        "__loader__.load_module('json')\n",
        "__loader__.exec_module(object())\n",
        "__loader__.create_module(None)\n",
        "__loader__.get_code('json')\n",
        "__loader__.get_source('json')\n",
        "from f017_oracle_primary_decoders import loads\nloads('{}')\n",
        "from f017_oracle_primary_decoders import load as decode\ndecode(None)\n",
        "def f(value=getattr):\n    return value\nf.__defaults__\n",
        "def f():\n    return 1\nf.__kwdefaults__\n",
        "def f():\n    return 1\nf.__code__.co_consts\n",
        "def outer():\n    value = 1\n    return lambda: value\nouter().__closure__\n",
        "import pkgutil\nbackend = pkgutil.resolve_name('json:loads')\nbackend('{}')\n",
        "import pkgutil as resolver\nresolver.resolve_name('json.decoder:JSONDecoder')().decode('{}')\n",
        "from pkgutil import resolve_name\nbackend = resolve_name('json:loads')\nbackend('{}')\n",
        "from pkgutil import resolve_name as locate\nlocate('json:loads')('{}')\n",
        "import pydoc\npydoc.locate('json.loads')('{}')\n",
        "from pydoc import locate\nlocate('json.loads')('{}')\n",
        "import pydoc\npydoc.safeimport('json').loads('{}')\n",
        "from pydoc import safeimport\nsafeimport('json').loads('{}')\n",
        "import runpy\nrunpy.run_module('json')\n",
        "from runpy import run_module\nrun_module('json')\n",
        "import runpy\nrunpy.run_path('/tmp/attacker.py')\n",
        "from runpy import run_path\nrun_path('/tmp/attacker.py')\n",
        "import ctypes\nctypes.pythonapi.PyImport_ImportModule(b'json')\n",
        "from ctypes import pythonapi\npythonapi.PyImport_ImportModule(b'json')\n",
        "import modulefinder\nmodulefinder.ModuleFinder().run_script('/tmp/attacker.py')\n",
        "import inspect\ninspect.getmodule(object())\n",
        "import ast\nast.literal_eval('{}')\n",
        "from ast import literal_eval\nliteral_eval('{}')\n",
        "import pickle\npickle.loads(b'cjson\\nloads\\n.')\n",
        "import marshal\nmarshal.loads(b'')\n",
        "from helper import resolve_name\nresolve_name('json:loads')('{}')\n",
        "import helper\nhelper.pkgutil.resolve_name('json:loads')('{}')\n",
        "import helper\nhelper.locate('json.loads')('{}')\n",
        "import typing\ndef shape() -> \"__import__('json').loads\": return None\nbackend = typing.get_type_hints(shape)['return']\nbackend('{}')\n",
        "import typing\ndef shape(value: \"__import__('json').loads\"): return value\nbackend = typing.get_type_hints(shape)['value']\nbackend('{}')\n",
        "import typing\nclass Shape:\n    value: \"__import__('json').loads\"\nbackend = typing.get_type_hints(Shape)['value']\nbackend('{}')\n",
        "import dataclasses, typing\n@dataclasses.dataclass\nclass Shape:\n    value: \"__import__('json').loads\"\nbackend = typing.get_type_hints(Shape)['value']\nbackend('{}')\n",
        "from typing import get_type_hints\ndef shape() -> \"__import__('json').loads\": return None\nget_type_hints(shape)['return']('{}')\n",
        "import typing\nbackend = typing.ForwardRef(\"__import__('json').loads\")._evaluate(globals(), locals(), set())\nbackend('{}')\n",
        "from typing import ForwardRef\nbackend = ForwardRef(\"__import__('json').loads\")._evaluate(globals(), locals(), set())\nbackend('{}')\n",
        "from typing import evaluate_forward_ref\nevaluate_forward_ref(object())\n",
        "import typing\n_P = 'js'\ndef shape() -> f\"__import__('{_P}on').loads\": return None\nbackend = typing.get_type_hints(shape)['return']\nbackend('{}')\n",
        "def resolver(): return object()\nbackend = resolver()\nbackend('{}')\n",
        "def resolver(): return object()\nbackend = resolver()['return']\nbackend('{}')\n",
        "def resolver(): return object()\nbackend = resolver()['return']\nalias = backend\nalias('{}')\n",
        "def resolver(): return object()\nclass Holder: backend = resolver()['return']\nHolder.backend('{}')\n",
    ],
)
