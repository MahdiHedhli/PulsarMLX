#!/usr/bin/env python3
"""CI-safe semantic checks for the committed real IQ3_XXS qualification."""
...
RECORD = (
    ROOT
    / "docs/research/glm52/raw/f016-iq3-xxs-numpy-qualification-0001.json"
)
...
class Iq3XxsQualificationRecordTests(unittest.TestCase):
    def test_real_matrix_exact_bit_and_identity_gates(self) -> None:
        ...
        for case in record["cases"]:
            self.assertEqual(case["shape"], [6144, 2048])
            self.assertEqual(case["encoded_bytes"], 4_816_896)
