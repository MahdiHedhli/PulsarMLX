...
RECORD = ROOT / "docs/research/glm52/raw/f016-routed-expert-0001.json"
...
class Glm52RoutedExpertRecordTests(unittest.TestCase):
    def test_oracle_route_mixed_quant_and_read_contract(self) -> None:
        ...
        self.assertEqual(record["process_first_vector"]["storage_read_count"], 6146)
        for sample in record["samples"]["numpy_vectorized"]:
            self.assertEqual(sample["storage_read_count"], 6146)
