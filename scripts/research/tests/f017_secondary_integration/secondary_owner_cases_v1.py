...
def _separation_cases(work, view):
    ...
    mutations = {
        ...
        "prefix-import-alias-rebinding": ("secondary", None,
            "\nfrom f017_secondary_read_observation_factory_v1 import create_descriptor_store as open_secondary_descriptor_prefix\n"),
        "prefix-function-rebinding": ("secondary", None,
            "\ndef open_secondary_descriptor_prefix(*args, **kwargs):\n    return None\n"),
        "prefix-class-rebinding": ("secondary", None,
            "\nclass open_secondary_descriptor_prefix:\n    pass\n"),
        "prefix-local-import-rebinding": ("secondary",
            ("    validate_candidate_document(candidate)\n",
             "    from f017_secondary_read_observation_factory_v1 import create_descriptor_store as open_secondary_descriptor_prefix\n    validate_candidate_document(candidate)\n"), None),
        "prefix-global-rebinding": ("secondary", None,
            "\ndef mutation_scope():\n    global open_secondary_descriptor_prefix\n"),
        "plain-stale-import": ("secondary", None,
            "\nimport f017_corrected_oracle_secondary_target_source_v11 as stale_source\n"),
        "dynamic-import-helper": ("secondary", None,
            "\n__import__('f017_corrected_oracle_secondary_target_source_v11')\n"),
        "missing-owner-forwarding": ("factory",
            ("_observation_owner=_observation_owner", "_observation_owner=None"), None),
        "missing-prefix-owner-forwarding": ("prefix",
            ("_observation_owner=self.owner", "_observation_owner=None"), None),
        "unobserved-store-to-core": ("secondary",
            ("store=store, _write_once=True", "store=None, _write_once=True"), None),
        "dead-branch-candidate-validation": ("secondary",
            ("    validate_candidate_document(candidate)\n",
             "    if False:\n        validate_candidate_document(candidate)\n"), None),
        "attribute-candidate-validation": ("secondary",
            ("    validate_candidate_document(candidate)\n",
             "    other.validate_candidate_document(candidate)\n"), None),
        "primary-source-rebinding": ("primary", None,
            "\nsource_from_inherited_descriptors = lambda *args, **kwargs: None\n"),
        "primary-source-definition-rebinding": ("primary", None,
            "\ndef source_from_inherited_descriptors(*args, **kwargs):\n    return None\n"),
        "primary-secondary-import": ("primary", None,
            "\nimport f017_secondary_descriptor_source_v1 as secondary_source\n"),
        "primary-missing-source-call": ("primary",
            ("        source, geometry, token, position = source_from_inherited_descriptors(\n",
             "        source, geometry, token, position = missing_primary_source(\n"), None),
