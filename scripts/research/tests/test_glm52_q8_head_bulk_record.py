#!/usr/bin/env python3
"""CI-safe validation for the Q8_0 head-slab storage-only record."""
...
RECORD = ROOT / "docs/research/glm52/raw/post-f016-q8-head-bulk-scalar-0001.json"
TABLE = ROOT / "docs/research/glm52/tables/post-f016-q8-head-bulk-scalar-0001.md"
ANALYZER = ROOT / "scripts/research/analyze_glm52_q8_head.py"
SOURCE = "0f38f1d4448789b5a938ed9db3baa659c797ecf0"


class Q8HeadBulkRecordTests(unittest.TestCase):
    def test_record_contract_summaries_and_table(self) -> None:
        ...
        self.assertEqual(record["representative_mla_layer"]["operation_contract"], {"head_operations_per_sample": 128, "matrix_operations_per_sample": 4})
        ...
        self.assertEqual(mla["samples"][baseline][0]["head_storage_read_count"], 49_152)
        ...
        self.assertEqual(mla["samples"][candidate][0]["head_decoder_modes"], ["scalar_reference"])
