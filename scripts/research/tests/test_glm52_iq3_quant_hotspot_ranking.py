...
SOURCE = ROOT / "docs/research/glm52/raw/f016-inference-p1-iq3-0001.json"
COMMITTED_JSON = ROOT / "docs/research/glm52/raw/f016-p1-iq3-quant-hotspot-ranking-0001.json"
COMMITTED_TABLE = ROOT / "docs/research/glm52/tables/f016-p1-iq3-quant-hotspots.md"


class Glm52Iq3QuantHotspotRankingTests(unittest.TestCase):
    ...
    def test_ranking_recomputes_source_metrics_and_names_q6_next(self) -> None:
        source = json.loads(SOURCE.read_text(encoding="utf-8"))
        record = json.loads(COMMITTED_JSON.read_text(encoding="utf-8"))
        rows = record["ranking"]
        self.assertEqual(rows[0]["quantization"], "Q6_K")
        self.assertEqual(record["next_decoder_candidate"], "Q6_K")
