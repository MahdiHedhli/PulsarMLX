...
ROWS = (
    ...
    ("NUMERICAL_BRIDGE", "derive_bridge", "ValidatedNumericalBridgeV2", "PRIMARY_NUMERICAL", "numerical_view", "PRIMARY"),
    ("PRIMARY_LEGACY_VIEW", "numerical_view", "ValidatedConsumerView", "PRIMARY_NUMERICAL", "consumer_view", "PRIMARY"),
    ("NUMERICAL_BRIDGE", "derive_bridge", "ValidatedNumericalBridgeV2", "PRIMARY_RESULT", "result_bundle_view", "PRIMARY"),
    ...
    ("SECONDARY_RESULT", "build_bundle_binding", "list", "COMPARISON", "comparison_view", "COMPARISON"),
    ("COMPARISON_LEGACY_VIEW", "comparison_view", "ValidatedConsumerView", "COMPARISON", "consumer_view", "COMPARISON"),
    ("COMPARISON", "build_comparison_binding", "dict", "RELEASE", "release_view", "RELEASE"),
    ("RELEASE", "release", "dict", "RELEASE_BINDING", "build_release_binding", "RELEASE"),
    ("RELEASE_BINDING", "build_release_binding", "dict", "ACCOUNTING", "accounting_view", "ACCOUNTING"),
    ("ACCOUNTING_LEGACY_VIEW", "accounting_view", "ValidatedConsumerView", "ACCOUNTING", "consumer_view", "ACCOUNTING"),
    ("ACCOUNTING", "build_accounting_closure", "dict", "PACKAGE_TERMINAL", "package_terminal_view", "TERMINAL"),
