...
def main() -> None:
    ...
    result = {
        ...
        "static_design_mutations_rejected": 171,
        "runtime_closure_mutations_rejected": 6,
        "design_mutations_rejected": 177,
        "design_mutation_accounting": "171_STATIC_PLUS_6_RUNTIME_AUTHORITY_CLOSURE_ATTACKS",
