...
def main() -> None:
    ...
    result = {
        ...
        "static_design_mutations_rejected": 126,
        "runtime_closure_mutations_rejected": 2,
        "design_mutations_rejected": 128,
        "design_mutation_accounting": "126_STATIC_PLUS_2_RUNTIME_CLOSURE_ATTACKS",
