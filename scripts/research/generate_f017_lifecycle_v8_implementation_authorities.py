...
def generate() -> None:
    ...
    manifest = {
        ...
        "synthetic_qualification": binding("docs/architecture/reviews/evidence/f017-corrected-oracle-lifecycle-v8-synthetic-qualification-v1.json"),
        "production_shaped_rehearsal": binding("scripts/research/rehearse_f017_corrected_oracle_event04_v8.py"),
        "production_shaped_rehearsal_evidence": binding("docs/architecture/reviews/evidence/f017-corrected-oracle-event04-production-shaped-rehearsal-v8.json"),
