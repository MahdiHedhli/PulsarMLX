...
CODE_FILES += (
    ...
    'scripts/research/glm53_flash/decoder_moe/capsule.py',
    'scripts/research/glm53_flash/decoder_moe/source.py',
    'scripts/research/glm53_flash/decoder_moe/oracle.py',
    'scripts/research/glm53_flash/decoder_moe/controls.py',
    'scripts/research/glm53_flash/decoder_moe/generate_fixtures.py',
    'scripts/research/glm53_flash/decoder_moe/upstream-switch-layers.txt',
    'scripts/research/glm53_flash/decoder_moe/LICENSE.upstream',
    'scripts/research/glm53_flash/decoder_moe/upstream-dsv32-language.txt',
    'fixtures/research/glm53-flash-decoder-moe-v1/fixtures.json',
    'scripts/research/glm53_flash/decoder_sparse/capsule.py',
    'scripts/research/glm53_flash/decoder_sparse/source.py',
    'scripts/research/glm53_flash/decoder_sparse/oracle.py',
    'scripts/research/glm53_flash/decoder_sparse/controls.py',
    'scripts/research/glm53_flash/decoder_sparse/generate_fixtures.py',
    'scripts/research/glm53_flash/decoder_sparse/upstream-mla.txt',
    'scripts/research/glm53_flash/decoder_sparse/upstream-base.txt',
    'scripts/research/glm53_flash/decoder_sparse/LICENSE.upstream',
    'fixtures/research/glm53-flash-decoder-sparse-v1/fixtures.json',
    'scripts/research/glm53_flash/decoder_stack/capsule.py',
    'scripts/research/glm53_flash/decoder_stack/source.py',
    'scripts/research/glm53_flash/decoder_stack/oracle.py',
    'scripts/research/glm53_flash/decoder_stack/controls.py',
    'scripts/research/glm53_flash/decoder_stack/generate_fixtures.py',
    'scripts/research/glm53_flash/decoder_stack/LICENSE.upstream',
    'fixtures/research/glm53-flash-decoder-stack-v1/fixtures.json',
    'scripts/research/glm53_flash/decoder_sparse_decode/oracle.py',
    ...
    'scripts/research/glm53_flash/decoder_stack_sanitize/oracle.py',
    'scripts/research/glm53_flash/decoder_stack_sanitize/controls.py',
    ...
    'scripts/research/glm53_flash/decoder_topology/controls.py',
    'scripts/research/glm53_flash/decoder_topology/generate_fixtures.py',
    'scripts/research/glm53_flash/decoder_topology/upstream-config.json',
    'scripts/research/glm53_flash/decoder_topology/LICENSE.upstream',
    'fixtures/research/glm53-flash-decoder-topology-v1/fixtures.json',
    'scripts/research/glm53_flash/linear_long/oracle.py',
    'scripts/research/glm53_flash/linear_long/controls.py',
    'scripts/research/glm53_flash/linear_long/generate_fixtures.py',
    'scripts/research/glm53_flash/linear_long/LICENSE.upstream',
    'fixtures/research/glm53-flash-linear-long-v1/fixtures.json',
    'scripts/research/glm53_flash/decoder_offload/oracle.py',
    'scripts/research/glm53_flash/decoder_offload/source.py',
    'scripts/research/glm53_flash/decoder_offload/controls.py',
    'scripts/research/glm53_flash/decoder_offload/generate_fixtures.py',
    'scripts/research/glm53_flash/decoder_offload/upstream-moe-offload.txt',
    'scripts/research/glm53_flash/decoder_offload/LICENSE.upstream',
    'fixtures/research/glm53-flash-decoder-offload-v1/fixtures.json',
    'scripts/research/glm53_flash/decoder_load_offload/source.py',
    'scripts/research/glm53_flash/decoder_load_offload/controls.py',
    'scripts/research/glm53_flash/decoder_load_offload/generate_fixtures.py',
    'scripts/research/glm53_flash/decoder_load_offload/upstream-one-bit.txt',
    'scripts/research/glm53_flash/decoder_load_offload/LICENSE.upstream',
    'fixtures/research/glm53-flash-decoder-load-offload-v1/fixtures.json',
    'scripts/research/glm53_flash/decoder_quantized_load/controls.py',
